...
{  
	...
	public BulletType1(float x,float y,ObjectId id, boolean facingRight)
	{	
		super(x,y,id,facingRight,BulletId.Bullet1);
		...
		this.y=y+6;
		bulletRight= new Animation(3,tex.bullet1[0],tex.bullet1[1]);
		bulletLeft= new Animation(3,tex.bullet1[2],tex.bullet1[3]);
